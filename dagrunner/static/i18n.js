const I18N_EN = {
  ...
  "通知渠道配置": "Notification channels",
  "邮件 SMTP": "Email SMTP",
  "配置所有工作流共用的发件账号。收件人与发送时机仍在各工作流的通知面板中配置。": "Configure the sender account shared by all workflows. Recipients and send timing remain in each workflow's notification panel.",
  "已配置": "Configured",
  "未配置": "Not configured",
  "SMTP 主机": "SMTP host",
  "端口": "Port",
  ...
  "已保存密码；留空不会修改": "A password is saved; leave blank to keep it",
  "请输入 SMTP 密码或授权码": "Enter the SMTP password or app password",
  "发件邮箱": "Sender address",
  "连接安全": "Connection security",
  "无加密": "No encryption",
  "超时（秒）": "Timeout (seconds)",
  "邮件主题前缀": "Subject prefix",
  "当前仅支持邮件渠道；此页面后续可继续增加飞书等通知渠道。": "Email is currently supported; more channels such as Feishu can be added here later.",
  "保存发件配置": "Save sender settings",
  "发件配置已保存": "Sender settings saved",
  "通知": "Notification",
  "邮件通知": "Email notification",
  "工作流结果邮件": "Workflow result email",
  "每次工作流结束后最多发送一封邮件，发件账号取自 var 通知配置。": "Send at most one email after each workflow run. The sender account comes from the var notifier config.",
  "发送时机": "When to send",
  "不发送": "Do not send",
  "仅成功时发送": "On success only",
  "仅失败时发送": "On failure only",
  "成功或失败都发送": "On success or failure",
  "收件邮箱": "Recipients",
  "每行填写一个邮箱，也可以使用逗号或分号分隔。保存后会更新完整的工作流 YAML 配置。": "Enter one address per line, or separate addresses with commas or semicolons. Saving updates the complete workflow YAML.",
  "启用邮件通知时至少填写一个收件邮箱": "Enter at least one recipient when email notification is enabled",
  "收件邮箱格式不正确": "A recipient email address is invalid",
